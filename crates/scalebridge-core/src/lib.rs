...
pub struct DeviceProfile {
    ...
    pub service_uuid: Option<&'static str>,
    pub notify_uuid: Option<&'static str>,
    pub write_uuid: Option<&'static str>,
}
...
impl DeviceProfile {
    ...
    pub fn detect(advertisement: &DeviceAdvertisement, discovered_services: &[String]) -> Self {
        ...
        if matches!(name, "eufy T9148" | "eufy T9149") {
            return Self {
                ...
                service_uuid: Some(uuids::T9120_SERVICE),
                notify_uuid: Some(uuids::T9120_NOTIFY),
                write_uuid: Some(uuids::T9120_WRITE),
            };
        }
    ...
    pub fn t9140_v1() -> Self {
        Self {
            ...
            service_uuid: Some(uuids::T9140_V1_SERVICE),
            notify_uuid: Some(uuids::T9140_V1_NOTIFY),
            write_uuid: Some(uuids::T9140_V1_WRITE),
        }
    }
    ...
    pub fn t9140_v2() -> Self {
        Self {
            ...
            service_uuid: Some(uuids::T9140_V2_SERVICE),
            notify_uuid: Some(uuids::T9140_V2_NOTIFY),
            write_uuid: Some(uuids::T9140_V2_WRITE),
        }
    }
    ...
    pub fn t9140_v3() -> Self {
        Self {
            ...
            service_uuid: Some(uuids::T9140_V3_SERVICE),
            notify_uuid: Some(uuids::T9140_V3_NOTIFY),
            write_uuid: Some(uuids::T9140_V3_WRITE),
        }
    }
}
